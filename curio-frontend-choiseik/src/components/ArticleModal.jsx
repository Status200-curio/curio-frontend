        ...
        <div className="p-8 flex flex-col gap-5">
          ...
          {article.ai_summary && (
            <div className="bg-blue-50 dark:bg-blue-950/40 rounded-2xl p-5 border border-blue-100 dark:border-blue-900/50">
              <p className="text-xs font-bold text-blue-600 dark:text-blue-400 mb-2">AI 요약</p>
              <p className="text-sm text-slate-700 dark:text-slate-300 leading-relaxed">{article.ai_summary}</p>
            </div>
          )}
          ...
          {article.ai_insight && (
            <div className="bg-indigo-50 dark:bg-indigo-950/40 rounded-2xl p-5 border border-indigo-100 dark:border-indigo-900/50">
              <p className="text-xs font-bold text-indigo-600 dark:text-indigo-400 mb-2">AI 인사이트</p>
              <p className="text-sm text-slate-700 dark:text-slate-300 leading-relaxed">{article.ai_insight}</p>
            </div>
          )}
